...
## 1 · 🟢 NEXT SESSION OPENER — 🔒 GRAPH ENCRYPTED AT REST (ADR-SEC-002, cold DoD GREEN, ready to commit); NEXT = verify CI green, then pick the next arc
